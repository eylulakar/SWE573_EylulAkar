...
<head>
  <meta charset="utf-8">
  <title>Login | Stay Healthy</title>
    ...
    <div class="row">
      <div class="content col-sm-12 col-md-12">
		<div class="row filter-elements hidden">
		  ...
		  <div class="col-xs-12 col-sm-6 col-md-6 box login">
			<form class="form-box login-form form-validator" id="formLogin">
			  <h3 class="title">Login</h3>
			  <p>If you have an account with us, please log in.</p>
			  
			  <div class="form-group">
				<label>Email Address: <span class="required">*</span></label>
				<input class="form-control" name="formLoginEmail" id="formLoginEmail" type="email" required data-bv-emailaddress-message="The input is not a valid email address">
              </div>
			  
			  <div class="form-group">
				<label>Password: <span class="required">*</span></label>
                <input class="form-control" name="formLoginPassword" id="formLoginPassword" type="password" required>
              </div>
			  ...
			  <div class="buttons-box clearfix">
				...
				<a href="forgot-password.jsp" class="forgot">Forgot Your Password?</a>
				<span class="required"><b>*</b> Required Field</span>
			  </div>
			  <div class="form-group">
				<div id="divLoginMessage" style="padding-top:10px;"></div>               
              </div>
			</form><!-- .form-box -->
		  </div>

		  <div class="col-xs-12 col-sm-6 col-md-6 box register">
			<form class="form-box register-form form-validator" id="formRegister"  method="post">
			  <h3 class="title">New Member</h3>	
			  
			  <div class="form-group">
				<label>Full name: <span class="required">*</span></label>
                <input type="text" class="form-control" name="formRegisterFullName" id="formRegisterFullName" data-bv-trigger="keyup" required data-bv-notempty-message="The full name cannot be empty">
              </div>

			  <div class="form-group">
				<label>Date of Birth: <span class="required">*</span></label>
                <input type="text" class="form-control" name="formRegisterDateOfBirth" id="formRegisterDateOfBirth" data-provide="datepicker" data-bv-trigger="keyup" required data-bv-notempty-message="The date of birth cannot be empty">
              </div>
              
                <div class="form-group">
				<label>Gender: <span class="required">*</span></label>
               <select class="form-control" name="formRegisterGender" id="formRegisterGender" required data-bv-trigger="keyup" required data-bv-notempty-message="The gender cannot be empty">
			<option disabled selected value>-Select-</option>
			  <option value="1">Male</option>
			  <option value="0">Female</option>			  
			</select>
               
<!-- <input type="text" class="form-control" name="Gender" id="Gender" data-bv-trigger="keyup" required data-bv-notempty-message="The gender cannot be empty">
      -->         </div>
				
			  <div class="form-group">
				<label>Password: <span class="required">*</span></label>
                <input class="form-control" name="formRegisterPassword" id="formRegisterPassword" type="password" required>
              </div>
			  
			  <div class="form-group">
				<label>Email: <span class="required">*</span></label>
				<input class="form-control" name="formRegisterEmail" id="formRegisterEmail" type="email" required data-bv-emailaddress-message="The input is not a valid email address">
              </div>
			  ...
			  <div class="buttons-box clearfix">
			    ...
			    <div class="form-group">
				 <div id="divRegisterMessage" style="padding-top:10px;"></div>
		  ...
		  <div class="col-xs-12 col-sm-6 col-md-6 box register">
			<div class="info-box">
			  ...
			  <p class="descriptions">By creating an account with our store, you will be able to move through the checkout process faster, store multiple shipping addresses, view and track your orders in your account and more.</p>
			  <button id="login-account" class="btn btn-default filter-buttons active-form" data-filter=".login">Login</button>
			</div>
		  </div>
		</div>
      </div>
